#!/usr/bin/env python3
#
# trid_lite.py - Lightweight TrID implementation (modified)
#
# Based on TrID (C) 2003-2026 by Marco Pontello - https://mark0.net
#
...
# This file is a modified, stripped-down version of the original TrID
# source code. Modifications were made to extract only the file-type
# identification engine, removing CLI, network update, and other features.
# Date of modification: 2026
# -----------------------------------------------------------------------
